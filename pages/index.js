        ...
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="pt-6">
            <h2 className="prose pt-5 text-lg text-gray-600 dark:text-gray-300">
              {`Welcome to ${siteMetadata.description}. Beneath the vast expanse of a star-speckled sky, the old lighthouse stood resolute against the crashing waves, its beacon slicing through the misty darkness, guiding weary sailors to safety while harboring countless stories of lost ships, whispered legends, and the echoes of long-forgotten journeys. `}
                  ...
                  <Link href="/projects">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      <span className="flex items-center space-x-5">
                        ...
                        <span className="pr-6 text-gray-900 dark:text-gray-100">What to built</span>
                      </span>
                  ...
                  <Link href="https://parthdesai.vercel.app/">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      <span className="flex items-center space-x-5">
                        ...
                        <span className="pr-6 text-gray-900 dark:text-gray-100">Read story</span>
                      </span>
