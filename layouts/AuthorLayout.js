        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8 xl:sticky xl:top-0">
            ...
            <div className="flex flex-col pt-3">
              <a
                ...
                href="https://twitter.com/messages/compose?recipient_id=4302974298&text=Hey Prudhvi"
                data-screen-name="@_Prudhvi_"
                target="_blank"
          ...
          <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
            <p>
              ...
              >
                {text1}  consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatu
              </RoughNotation>
            </p>
            <br />
            <p>
            ...
            consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pa
            ...
            <p className="hidden md:block">
             pejfijiIPIPNOIWNRGNIKNSWOIKENDIFKNWSEOIDNGVOIWES
              <RoughNotation
                animationDelay="1000"
                animationDuration="3000"
                type="highlight"
              ...
              >
                <span className="text-black dark:text-white">
                  AKHBDIFBISEBAIHFUIAEDUJFBHEAUHLKAZVHOIA
                </span>
              </RoughNotation>
              LJAHDUOFHUEHFOUHEAUIHGUIHWIASHEGHIASH
              <RoughNotation
                type="underline"
                show={true}
                color="#FBCFE8"
                ...
                multiline={true}
              >
                JOAHDUFOHUOAHSEUHGFUIGADUIFIUAHDIGUFUIABIUFHIUAEHF
              </RoughNotation>
            </p>
            <br />
            <p>
             KHBSIDBIUFBVJIWSEBDIJVBFISJBGIKBSJFNDUOGBSRUOFHBJFDJBJFHD
              <Link
                href={'mailto:saiprudhviraja006@gmail.com'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-100"
              >
                Mail
                <svg
              ...
              or{' '}
              <Link
                href={'https://api.whatsapp.com/send?phone=9949229280&text=hi'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-100"
              >
                Whatsapp
                <svg
            ...
            <p>
             knbdkzbvkbdkvbzdbvbjkzbdjkbvjkbjkdzbjv
              <ul>
                <li>
                  <Link
                ...
                <li>
                  ...
                  khbsjodbnvjosnojsnadnvnjsongdv
                </li>
              </ul>
            </p>
          </div>
